<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link type="primary" href="https://docs.spicyboy.cn" target="_blank">SFire-Admin</el-link>
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="Gitee" label-align="left">
          <el-link type="primary" href="https://gitee.com/HalseySpicy/SFire-Admin" target="_blank"> Gitee </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="Github" label-align="left">
          <el-link type="primary" href="https://github.com/HalseySpicy/SFire-Admin" target="_blank"> Github </el-link>
        </el-descriptions-item>
